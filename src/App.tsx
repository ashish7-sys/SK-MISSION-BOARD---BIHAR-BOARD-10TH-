          ...
          <header className="sticky top-0 z-40 bg-slate-950/70 backdrop-blur-xl border-b border-white/10 px-3 sm:px-8 py-2.5 sm:py-3.5 flex items-center justify-between shadow-2xl transition-all">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 sm:px-3.5 py-2 sm:py-2.5 rounded-xl bg-purple-500/20 hover:bg-purple-500/30 backdrop-blur-md border border-purple-500/30 text-purple-200 text-xs sm:text-base font-bold transition-all shadow-md cursor-pointer shrink-0 whitespace-nowrap"
              >
