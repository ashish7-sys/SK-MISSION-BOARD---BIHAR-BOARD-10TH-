      ...
      <div className="relative w-full max-w-lg rounded-3xl bg-slate-900/95 border border-cyan-500/30 p-6 sm:p-8 shadow-[0_0_50px_rgba(6,182,212,0.2)] text-slate-100 overflow-hidden my-auto">
        ...
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <h2 className="text-xl sm:text-2xl font-black text-white tracking-tight">
            {isOnboarding ? "विद्यार्थी प्रोफाइल सेटअप" : "प्रोफाइल विवरण बदलें"}
          </h2>
          <p className="text-xs sm:text-sm text-slate-400 mt-1 max-w-sm">
            {isOnboarding 
              ? "SK AI Study Assistant आपके अध्ययन अनुभव को व्यक्तिगत और सरल बनाएगा।"
              : "यह जानकारी AI अध्ययन सहायक के व्यक्तिगत संबोधन के लिए उपयोग की जाती है।"}
          </p>
        </div>
        ...
        <form onSubmit={handleSave} className="space-y-4 sm:space-y-5">
          ...
          <div className="flex items-center gap-2 p-2.5 rounded-xl bg-slate-950/60 border border-white/5 text-[11px] text-slate-400">
            ...
            <span>आपकी जानकारी 100% निजी है और केवल AI वैयक्तिकरण के लिए उपयोग की जाएगी।</span>
          </div>
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            >
              {isSaving ? (
                ...
                <>
                  <span>{isOnboarding ? "Continue (आगे बढ़ें)" : "Save Changes (सहेजें)"}</span>
