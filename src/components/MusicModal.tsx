...
export const MusicModal: React.FC<MusicModalProps> = ({ tracks, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/85 backdrop-blur-xl animate-fade-in overflow-y-auto">
      <div className="relative w-full max-w-2xl rounded-3xl bg-slate-900/95 border border-slate-800 shadow-[0_20px_50px_rgba(0,0,0,0.8)] p-5 sm:p-7 backdrop-blur-2xl overflow-hidden my-auto">
        {/* Ambient Glow */}
        ...
        <button
          onClick={onClose}
          className="absolute top-5 right-5 p-2.5 rounded-full bg-slate-800/80 hover:bg-slate-700 text-slate-400 hover:text-white transition-all cursor-pointer z-10"
        ...
        <div className="text-center mb-6 pr-8 sm:pr-0">
          ...
          <p className="text-xs sm:text-sm text-slate-400 mt-1 max-w-md mx-auto">
            बिहार बोर्ड परीक्षा 2026 की एकाग्रता व शांत अध्ययन हेतु वाद्य संगीत
          </p>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-slate-950/80 border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="text-center sm:text-left flex-1 min-w-0">
            ...
            <h4 className="text-base sm:text-lg font-black text-white truncate mt-0.5">
              {currentTrack ? currentTrack.title : "ऊपर दिए गए किसी भी म्यूजिक पर क्लिक करें"}
            </h4>
          </div>
