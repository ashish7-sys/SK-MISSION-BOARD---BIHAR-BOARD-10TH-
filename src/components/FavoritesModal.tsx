      ...
      <div className="relative w-full max-w-4xl rounded-3xl bg-slate-900/95 border border-slate-800 shadow-[0_25px_60px_rgba(0,0,0,0.9)] p-5 sm:p-7 backdrop-blur-2xl overflow-hidden my-auto max-h-[90vh] flex flex-col">
        ...
        <div className="py-4 space-y-3 shrink-0">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="सहेजे गए बुकमार्क खोजें (Search saved items)..."
              value={searchQuery}
          ...
          {filteredBookmarks.length === 0 ? (
            <div className="py-16 text-center text-slate-400 space-y-3">
              ...
              <p className="text-base font-bold text-slate-200">
                {bookmarks.length === 0 ? "कोई बुकमार्क सहेजा नहीं गया है" : "खोज के अनुसार कोई बुकमार्क नहीं मिला"}
              </p>
              <p className="text-xs sm:text-sm text-slate-500 max-w-md mx-auto">
                PDF नोट्स, वीडियो क्लासेस या अध्यायों पर <Bookmark className="w-3.5 h-3.5 inline text-amber-400" /> आइकन दबाकर उन्हें आसानी से पसंदीदा सूची में जोड़ें।
              </p>
            </div>
          ) : (
        ...
        <div className="pt-3 border-t border-slate-800/80 flex items-center justify-between text-xs text-slate-500 shrink-0">
          <span>सुरक्षित निजी बुकमार्क (Private local storage)</span>
          {bookmarks.length > 0 && (
            <button
              onClick={() => {
                if (window.confirm("क्या आप सभी बुकमार्क हटाना चाहते हैं?")) {
