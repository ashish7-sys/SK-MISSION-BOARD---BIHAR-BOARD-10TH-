    ...
    <div className="space-y-6 text-white pb-6">
      ...
      <div className="bg-slate-950/80 p-4 sm:p-5 rounded-3xl border border-slate-800/80 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-xl">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-lg sm:text-xl font-black text-white">
                गोपनीयता-सुरक्षित एडमिन एनालिटिक्स (Privacy-Friendly Analytics)
              </h2>
            ...
            <p className="text-xs text-slate-400 mt-0.5 flex items-center gap-1.5">
              ...
              केवल समग्र सांख्यिकी (Aggregate stats) — शून्य व्यक्तिगत डेटा संग्रह
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="p-2.5 rounded-2xl bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-300 hover:text-white transition-all disabled:opacity-50"
            title="रिफ्रेश करें"
          >
          ...
          <button
            ...
            className="px-3 py-2 rounded-2xl bg-indigo-600/20 hover:bg-indigo-600/30 text-indigo-300 border border-indigo-500/30 text-xs font-bold flex items-center gap-1.5 transition-colors"
          >
            <DownloadCloud className="w-3.5 h-3.5" /> एक्सपोर्ट
          </button>
        </div>
      </div>
      ...
      <div className="p-3.5 rounded-2xl bg-emerald-950/40 border border-emerald-500/30 flex items-center justify-between text-xs text-emerald-200">
        <div className="flex items-center gap-2">
          ...
          <span>
            <strong>गोपनीयता नीति सुरक्षा:</strong> छात्रों के पासवर्ड, संपर्क, निजी AI बातचीत या व्यक्तिगत फाइलें कभी ट्रैक नहीं की जातीं।
          </span>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-slate-950/70 p-4 rounded-3xl border border-slate-800/90 shadow-lg relative overflow-hidden group hover:border-slate-700 transition-all">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">सक्रिय छात्र (Active Users)</span>
        ...
        <div className="bg-slate-950/70 p-4 rounded-3xl border border-slate-800/90 shadow-lg relative overflow-hidden group hover:border-slate-700 transition-all">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">सामग्री उपयोग (Resource Views)</span>
          ...
          <div className="mt-2 text-[11px] text-purple-300/80 flex items-center gap-1.5">
            <span>PDFs + लेक्चर्स + म्यूजिक</span>
          </div>
        </div>
        ...
        <div className="bg-slate-950/70 p-4 rounded-3xl border border-slate-800/90 shadow-lg relative overflow-hidden group hover:border-slate-700 transition-all">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">PDF अध्ययन व डाउनलोड</span>
          ...
          <div className="mt-3 flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-400">खोलें</span>
          </div>
          <div className="mt-2 text-[11px] text-pink-400 font-bold flex items-center gap-1">
            <Download className="w-3 h-3" />
            <span>{summary.totalPdfDownloads.toLocaleString()} ऑफ़लाइन डाउनलोड्स</span>
          </div>
        </div>
        ...
        <div className="bg-slate-950/70 p-4 rounded-3xl border border-slate-800/90 shadow-lg relative overflow-hidden group hover:border-slate-700 transition-all">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">वीडियो व म्यूजिक वादन</span>
          ...
          <div className="mt-3 flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-400">प्ले</span>
          </div>
          <div className="mt-2 text-[11px] text-amber-300/90 flex items-center gap-2">
            <span>🎥 {summary.totalVideoPlays.toLocaleString()} वीडियो</span>
            <span>•</span>
            <span>🎵 {summary.totalMusicPlays.toLocaleString()} म्यूजिक</span>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-br from-cyan-950/30 via-slate-950/80 to-blue-950/30 p-5 rounded-3xl border border-cyan-500/30 shadow-2xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-cyan-500/20 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-black text-white flex items-center gap-2">
                AI अध्ययन सहायक सांख्यिकी (AI Study Assistant Analytics)
              </h3>
              <p className="text-xs text-cyan-300/80">
                छात्रों द्वारा AI सहायक से पूछे गए प्रश्नों की कुल गणना (Aggregate Metrics Only)
              </p>
            </div>
          </div>
          ...
          <div className="px-3 py-1.5 rounded-xl bg-slate-900/90 border border-slate-800 text-[11px] text-slate-300 flex items-center gap-1.5">
            ...
            <span>बातचीत पाठ (Chat Content) एडमिन से पूर्णतः सुरक्षित व छुपा रहता है</span>
          </div>
        </div>
        ...
        <div className="mt-4 pt-3 border-t border-cyan-500/20">
          <div className="flex items-center justify-between text-xs text-slate-400 mb-1.5">
            <span>प्रश्न माध्यम वितरण (Query Modality Split):</span>
            <span className="text-cyan-300 font-bold">
              {summary.aiQuestionsAsked > 0 ? Math.round(((summary.aiQuestionsAsked - summary.aiImageQuestions) / summary.aiQuestionsAsked) * 100) : 88}% टेक्स्ट • {summary.aiQuestionsAsked > 0 ? Math.round((summary.aiImageQuestions / summary.aiQuestionsAsked) * 100) : 12}% चित्र
            </span>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between pb-3 border-b border-slate-800">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-black text-white">सर्वाधिक अध्ययन किए गए विषय (Top Subjects)</h3>
              </div>
                ...
                <div key={sub.subjectId} className="space-y-1.5">
                  <div className="flex items-center justify-between text-xs">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold text-white">{sub.nameHindi}</span>
                      <span className="text-slate-400 text-[11px]">({sub.name})</span>
                    </div>
                    <div className="flex items-center gap-2 font-mono">
                      <span className="font-bold text-amber-400">{sub.count.toLocaleString()} उपयोग</span>
        ...
        <div className="bg-slate-950/70 p-5 rounded-3xl border border-slate-800 shadow-xl">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-black text-white">सर्वाधिक अध्ययन किए गए अध्याय (Top Chapters)</h3>
            </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2.5 min-w-0 pr-2">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-[10px] text-slate-400 flex items-center gap-1">
                        <span className="text-cyan-400 font-semibold">{subObj?.nameHindi || ch.subjectId}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <span className="text-[10px] text-slate-500 block">सत्र</span>
                  </div>
                </div>
              );
            })}
      ...
      <div className="bg-slate-950/70 p-5 rounded-3xl border border-slate-800 shadow-xl">
        <div className="flex items-center justify-between pb-3 border-b border-slate-800">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-black text-white">सप्ताहिक गतिविधि रुझान (7-Day Activity Trend)</h3>
          </div>
          <span className="text-xs text-slate-400 font-mono">दैनिक आंकड़े</span>
        </div>

        <div className="grid grid-cols-7 gap-2 mt-4 pt-2">
          {summary.dailyActivityTrend.map((day, idx) => (
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mt-3 pt-2 text-[11px] text-slate-400">
          <span className="flex items-center gap-1.5">
            <span className="w-2.5 h-2.5 rounded-full bg-blue-500 inline-block" /> सक्रिय छात्र
          </span>
          <span className="flex items-center gap-1.5">
            <span className="w-2.5 h-2.5 rounded-full bg-pink-500 inline-block" /> PDF नोट्स अध्ययन
          </span>
          <span className="flex items-center gap-1.5">
            <span className="w-2.5 h-2.5 rounded-full bg-amber-400 inline-block" /> वीडियो लेक्चर्स
          </span>
        </div>
      </div>
      ...
      <div className="bg-slate-950/70 p-5 rounded-3xl border border-slate-800 shadow-xl space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-800">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-black text-white">सामग्री-स्तरीय उपयोग तालिका (Resource Breakdown Table)</h3>
          </div>
          ...
          <div className="flex items-center bg-slate-900 p-1 rounded-2xl border border-slate-800">
            ...
            >
              <FileText className="w-3.5 h-3.5" /> PDF नोट्स ({summary.resourceStats.pdfs.length})
            </button>
            <button
            ...
            >
              <Video className="w-3.5 h-3.5" /> वीडियो लेक्चर्स ({summary.resourceStats.videos.length})
            </button>
            <button
            ...
            >
              <Music className="w-3.5 h-3.5" /> म्यूजिक ({summary.resourceStats.music.length})
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-2.5">
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="रिसोर्स या अध्याय का नाम खोजें..."
        ...
        <div className="overflow-x-auto rounded-2xl border border-slate-800">
          <table className="w-full text-left text-xs text-slate-300">
            <thead className="bg-slate-900/90 text-slate-400 uppercase text-[10px] tracking-wider border-b border-slate-800">
              <tr>
                <th className="p-3">रिसोर्स शीर्षक</th>
                <th className="p-3">विषय / अध्याय</th>
                <th className="p-3 text-right">खोलने की संख्या (Opens)</th>
                <th className="p-3 text-right">कुल व्यूज (Views)</th>
                <th className="p-3 text-right">
                  {resourceFilter === "pdf" ? "डाउनलोड्स" : resourceFilter === "video" ? "प्ले" : "वादन"}
                </th>
              </tr>
            </thead>
                ...
                filteredResources.map((item, idx) => {
                  ...
                  return (
                    <tr key={item.id} className="hover:bg-slate-900/60 transition-colors">
                      ...
                      <td className="p-3">
                        <div className="text-slate-300 text-[11px] font-medium">{subObj?.nameHindi || "—"}</div>
